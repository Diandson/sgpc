...
export class ProductionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProduction): number => this.productionService.getProductionIdentifier(item);
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.productionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
