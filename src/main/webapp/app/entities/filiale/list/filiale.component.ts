...
export class FilialeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IFiliale): number => this.filialeService.getFilialeIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(filiale: IFiliale): void {
    const modalRef = this.modalService.open(FilialeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.filiales = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IFiliale[] | null): IFiliale[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.filialeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
