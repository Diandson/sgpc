...
export class ColisageComponent implements OnInit {
  ...
  trackId = (_index: number, item: IColisage): number => this.colisageService.getColisageIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(colisage: IColisage): void {
    const modalRef = this.modalService.open(ColisageDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.colisages = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IColisage[] | null): IColisage[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.colisageService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
